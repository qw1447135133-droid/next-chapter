...
示例结构（片段1-1包含3个分镜）：
[
  {"sceneNumber":1,"segmentLabel":"1-1","sceneName":"战场","description":"远景：荒野上两军对峙","characters":["角色A"],"dialogue":"","cameraDirection":"无字幕、无水印、无背景音","duration":15},
  {"sceneNumber":2,"segmentLabel":"1-1","sceneName":"战场","description":"中景：角色A举刀冲锋","characters":["角色A"],"dialogue":"角色A：冲啊！","cameraDirection":"无字幕、无水印、无背景音","duration":15},
  {"sceneNumber":3,"segmentLabel":"1-1","sceneName":"战场","description":"特写：刀刃碰撞火花四溅","characters":["角色A","角色B"],"dialogue":"","cameraDirection":"无字幕、无水印、无背景音","duration":15}
]
